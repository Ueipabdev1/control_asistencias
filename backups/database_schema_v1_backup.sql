-- =====================================================
-- BACKUP del Esquema Original - Sistema de Control de Asistencias
-- Fecha de Backup: 2026-02-03
-- Versión: 1.0 (Sistema de conteo por género)
-- =====================================================
-- IMPORTANTE: Este es el esquema ANTES de la refactorización
-- a sistema de asistencia individual por estudiante
-- =====================================================
...
-- =====================================================
-- Tabla: etapa
-- Almacena las etapas educativas
-- =====================================================
CREATE TABLE etapa (
...
-- =====================================================
-- Tabla: usuario
-- Almacena administradores y profesores
-- =====================================================
...
-- =====================================================
-- Tabla: secciones (VERSIÓN ANTIGUA - mezcla grado+sección)
-- =====================================================
...
-- =====================================================
-- Tabla: matricula (VERSIÓN ANTIGUA - conteo por género)
-- =====================================================
...
-- =====================================================
-- Tabla: asistencia (VERSIÓN ANTIGUA - conteo por género)
-- =====================================================
...
-- =====================================================
-- Datos iniciales: Secciones predefinidas
-- =====================================================
